        ...
        <div class="container">
            <form action="" method="">
                <div class="row">
                    ...
                    <div class="col form-group">
                            <input type="checkbox" name="check_historico" id="check_historico" value="">
                            <label for="check-404" class= "">Historico</label>
                        </div>
                
                    <div class="col form-group">
                        <button type="submit" class="form-control btn btn-secondary w-50">
